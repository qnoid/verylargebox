...
-(void)testWillAppear
{
	...
	NSObject<TheBoxDimension> *dimension = [TheBoxHeight newHeight:160];
...
{
	NSObject<TheBoxDimension> *dimension = [TheBoxWidth newWidth:cellSize.width];
...
-(void)testIsVisible
{
	NSObject<TheBoxDimension> *dimension = [TheBoxWidth newWidth:0];
